...
|---------------|-------------------------------------------|------------------------|
| **MyTasker**  | Task manager for productivity lovers      | React, Node.js, Kotlin         |
| **CodeSnap**  | Share and format code snippets easily     | HTML, CSS, JS, MachineLearning |
| **WeatherWise** | Real-time weather info in your city     | Python, Flask, API, Java, c    |
...
📬 Email: tanushreegowda57@gmail.com
